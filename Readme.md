...
# Parsing + Configuration Script – MNS2-9-IN-TS-ST. - Rev. A

This **Parsing + Configuration** script is designed for the **MNS2-9-IN-TS-ST.** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MNS2-9-IN-TS-ST. Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MNS2-9-IN-TS-ST.** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
